<template>
  <DivContainer>
    ...
    <label
      class="block w-full my-2 text-sm font-bold"
      for="instructions"
    ...
    <PriceTable />
    <div
      class="my-4 configurator-text-input"
      index="2"
    >
      <label
        for="quantity"
    ...
    <div
      class="my-4 capitalize"
      index="3"
    >
      <div class="pb-2 text-sm font-bold normal-case">
        <span class="property__text">If you added a logo or custom graphic, you will be sent a proof to
      ...
      <div class="flex w-full mb-4">
        <label
          for="line1"
          class="w-24 py-2 text-sm font-bold"
